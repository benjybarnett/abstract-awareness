function [perf, result, testlabel,cfs] = mv_classify_across_time_BOB(cfg, X, clabel)
...
%                 metric='none'
% cfs           - [1 x timepoints] cell array.All the different classifier 
%                 weights used across time. So one can select weights from
%                 the peak decoding time point.
