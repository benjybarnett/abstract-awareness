function [perf, result, testlabel,cfs,testidxs] = mv_classify_BOB(cfg, X, clabel)
...
% cfs           - cell array returning the trained classifier.
% testidxs       - cell array returning indices of test samples used in each fold.

% (c) matthias treder. Edited by Benjy Barnett 2022.
