...
disp('HAHAHAHAHAHAHAHAHAHAAAAAAAAAAAAAAAAAAHAHAHAHAHAHAHAHAHAHAAAAAAAAAAAAAAAAAAHAHAHAHAHAHAHAHAHAHAAAAAAAAAAAAAAAAAAHAHAHAHAHAHAHAHAHAHAAAAAAAAAAAAAAAAAA')
disp('HAHAHAHAHAHAHAHAHAHAAAAAAAAAAAAAAAAAAHAHAHAHAHAHAHAHAHAHAAAAAAAAAAAAAAAAAAHAHAHAHAHAHAHAHAHAHAAAAAAAAAAAAAAAAAAHAHAHAHAHAHAHAHAHAHAAAAAAAAAAAAAAAAAA')
...
sizetrl = size(trl);
disp(sizetrl);
length_trl = sizetrl(1);
for i =1:(length_trl-1)
  if trl(i+1,1) - trl(i,1) == 1
    remove_indexes = [remove_indexes i]
  end
end
trl(remove_indexes,:) =[];
%%%%%%%%%%%%%%%BENJY FINISHED%%%%%%%%%%%%%%%%%
